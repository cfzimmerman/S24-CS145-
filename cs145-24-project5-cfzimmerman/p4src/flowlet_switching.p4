...
control MyIngress(inout headers hdr,
    ...
    apply {
        ...
        if (meta.group_num != 0)  {
            ...
            /* Add your code here */
            /* ....... */
            flow_to_timestamp.read(previous_timestamp, flow_index);
            ...
            if (standard_metadata.ingress_global_timestamp - previous_timestamp > FLOWLET_TIME_GAP)  {
                ...
                /* Add your code here */
                /* ....... */
                // make a new flowlet id, 32 bit
                bit<32> flowlet_id;
                random(flowlet_id, (bit<32>)0, 65000);
                hash(meta.hash_index,
                    ...
                    // (bit<32>)4
                    meta.buckets_in_group
                );
                flow_to_hash_index.write(flow_index, meta.hash_index);
            } else {
                // Read stored hash_index from the corresponding switch register
                /* Add your code here */
                /* ....... */
                flow_to_hash_index.read(meta.hash_index, flow_index);
            }

            // Write timestamp to the corresponding switch register
            /* Add your code here */
            /* ....... */
            flow_to_timestamp.write(flow_index, standard_metadata.ingress_global_timestamp);
